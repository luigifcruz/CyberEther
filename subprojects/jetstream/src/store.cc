...
// Device::CPU
        ...
        { {"audio",             "cpu",  "F32",     "",     ""}, [](Instance& instance, Parser::ModuleRecord& r) { instance.addModule<Audio, Device::CPU, F32>(r); } },
#endif
#ifdef JETSTREAM_MODULE_FM_CPU_AVAILABLE
        { {"fm",                "cpu", "CF32",     "",     ""}, [](Instance& instance, Parser::ModuleRecord& r) { instance.addModule<FM, Device::CPU, CF32>(r); } },
#endif
#ifdef JETSTREAM_MODULE_MULTIPLY_CONSTANT_CPU_AVAILABLE
        { {"multiply-constant", "cpu",  "F32",     "",     ""}, [](Instance& instance, Parser::ModuleRecord& r) { instance.addModule<MultiplyConstant, Device::CPU,  F32>(r); } },
        { {"multiply-constant", "cpu", "CF32",     "",     ""}, [](Instance& instance, Parser::ModuleRecord& r) { instance.addModule<MultiplyConstant, Device::CPU, CF32>(r); } },
#endif
...
// Device::Metal
        ...
        { {"audio",             "metal",  "F32",     "",     ""}, [](Instance& instance, Parser::ModuleRecord& r) { instance.addModule<Audio, Device::Metal, F32>(r); } },
#endif
#ifdef JETSTREAM_MODULE_MULTIPLY_CONSTANT_CPU_AVAILABLE
        { {"multiply-constant", "metal",  "F32",     "",     ""}, [](Instance& instance, Parser::ModuleRecord& r) { instance.addModule<MultiplyConstant, Device::Metal,  F32>(r); } },
        { {"multiply-constant", "metal", "CF32",     "",     ""}, [](Instance& instance, Parser::ModuleRecord& r) { instance.addModule<MultiplyConstant, Device::Metal, CF32>(r); } },
#endif
