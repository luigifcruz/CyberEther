#ifndef JETSTREAM_BUNDLES_REMOTE_BASE_HH
#define JETSTREAM_BUNDLES_REMOTE_BASE_HH
    ...
    void drawControl() {
        ...
        if (ImGui::InputText("##EndpointAddress", &config.endpoint, ImGuiInputTextFlags_EnterReturnsTrue)) {
            JST_DISPATCH_ASYNC([&](){
                ...
                JST_CHECK_NOTIFY(instance().reloadModule(remote->locale()));
            });
        }
