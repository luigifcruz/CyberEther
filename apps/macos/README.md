...
The create stages only assemble the app bundle and DMG. The sign/notarize stages require Apple Developer ID and App Store Connect API credentials in environment variables. In GitHub Actions, release packaging signs and notarizes through the `macos-notarization` environment.
