...
TEST_CASE("Flowgraph lifecycle APIs behave consistently", "[core][flowgraph][api][lifecycle]") {
    Flowgraph flowgraph;
...
TEST_CASE_METHOD(FlowgraphFixture, "Flowgraph setter and getter APIs are covered", "[core][flowgraph][api]") {
    REQUIRE(flowgraph->path().empty());
...
TEST_CASE_METHOD(FlowgraphFixture, "Flowgraph metadata APIs are covered", "[core][flowgraph][api][metadata]") {
    REQUIRE(flowgraph->blockCreate("gen1", kSyntheticSourceType, {}, {}) == Result::SUCCESS);
...
TEST_CASE_METHOD(FlowgraphFixture, "Flowgraph environment APIs are covered", "[core][flowgraph][api][environment]") {
...
TEST_CASE_METHOD(FlowgraphFixture, "Flowgraph file APIs are covered", "[core][flowgraph][api][file]") {
...
TEST_CASE_METHOD(FlowgraphFixture, "Flowgraph blob APIs are covered", "[core][flowgraph][api][serialization]") {
...
graph:
  ...
  - name: startup
    module: flowgraph_test_isolated
)";
