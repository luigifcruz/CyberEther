...
JST_BENCHMARKS("multiply") {
    return {
        ...
        {
            .variant = "F32-128x512-broadcast",
            .inputs = {
                JST_BENCHMARK_INPUT("a", F32, 128, 1),
                JST_BENCHMARK_INPUT("b", F32, 128, 512),
            },
            .config = {},
        },
        {
        ...
        {
            .variant = "CF32-128x512-broadcast",
            .inputs = {
                JST_BENCHMARK_INPUT("a", CF32, 128, 1),
                JST_BENCHMARK_INPUT("b", CF32, 128, 512),
            },
            .config = {},
        },
    };
